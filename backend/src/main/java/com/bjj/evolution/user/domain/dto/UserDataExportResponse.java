...
public record UserDataExportResponse(
    ...
    public record TrainingEntry(
            ...
            List<String> submissionTechniques,
            List<String> submissionTechniquesAllowed,
            int totalRolls,
            int roundLengthMinutes,
            int restLengthMinutes,
        ...
        public static TrainingEntry fromEntity(Training t) {
            return new TrainingEntry(
                    ...
                    t.getSubmissionTechniques().stream().map(te -> te.getName()).toList(),
                    t.getSubmissionTechniquesAllowed().stream().map(te -> te.getName()).toList(),
                    t.getTotalRolls(),
